...
def edit_product_rating(request, id):
    # Get product rating berdasarkan id
    rating = Product.objects.get(pk = id)

    # Set product sebagai instance dari form
    form = ProductForm(request.POST or None, instance=rating)
    ...
    context = {'form': form}
    return render(request, "edit_product_rating.html", context)

def delete_product_rating(request, id):
    # Get product rating berdasarkan id
    rating = Product.objects.get(pk = id)
    rating.delete()
...
@csrf_exempt
@require_POST
def add_product_rating_ajax(request):
    name = strip_tags(request.POST.get("name"))
    price = strip_tags(request.POST.get("price"))
    feedback = strip_tags(request.POST.get("feedback"))
